...
const DashboardClientes = (callback) => {
...
const DashboardVendas = (callback) => {
    ...
    db.query(ssql, filtro, (err, result) => {
        if(err){
            callback(err, []);
        } else {
            // Titulos...
...
const DashboardProdutos = (callback) => {
...
const DashboardCidades = (callback) => {
